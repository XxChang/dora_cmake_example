...
if(DORA_ROOT_DIR)
    ...
    ExternalProject_Add(Dora
        ...
        BUILD_COMMAND
            ...
            --target-dir ${CMAKE_CURRENT_BINARY_DIR}/src/Dora/target
            &&
            cargo build
    ...
    add_custom_command(OUTPUT ${dora_c_include_dir}
        WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR}/src/Dora/apis/c
        COMMAND
            mkdir ${CMAKE_CURRENT_BINARY_DIR}/include/c -p
            &&
            cp node ${CMAKE_CURRENT_BINARY_DIR}/include/c -r
    ...
    add_custom_command(OUTPUT ${node_bridge} ${dora_cxx_include_dir} ${operator_bridge}
        WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR}/src/Dora/target
        DEPENDS Dora
        COMMAND
            mkdir ${dora_cxx_include_dir} -p
            &&
    ...
    set(dora_link_dirs ${CMAKE_CURRENT_BINARY_DIR}/src/Dora/target/debug)
